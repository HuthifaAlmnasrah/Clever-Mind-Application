...
public class SoonAdapter extends RecyclerView.Adapter<SoonAdapter.AdapterHolder>{

    List<SoonItem> items;

    public SoonAdapter(List<SoonItem> items) {
        this.items = items;
    }
    ...
    class AdapterHolder extends RecyclerView.ViewHolder{
        ...
        void setInfo(SoonItem info){
            txt.setText(info.getEventText());
        }
    }
}
